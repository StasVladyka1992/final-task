...
<div class="row">
    <div class="col-7">
        ...
        <p class="text-white footer-text constText">${address} ${location}</p>
        <p class="text-white footer-text constText">${email}: ${initParam['adminMail']}</p>
    </div>
    <div class="col-5">
...
<div class="row">
    <div class="col-12 text-center">
        <p class="text-white constText ">${rights}</p>
    </div>
</div>
</body>
</html>
