...
public final class JSPNavigation {
    ...
    public static final String ADD_REMEDY = "/secure?command=add_remedy";
    public static final String GO_TO_REMEDY_MODIFICATION_RESULT = "/secure?command=go_to_remedy_modification_result&";
    public static final String REMEDY_MODIFICATION_RESULT = "WEB-INF/jsp/secure/pharmacist/modification_result.jsp";
