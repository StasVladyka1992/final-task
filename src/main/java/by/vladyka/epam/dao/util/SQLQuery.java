...
public final class SQLQuery {
    ...
    //storage's queries
    public static final String QUERY_FIND_REMEDIES_BY_NAME = "SELECT r.id, r.name, r.price, r.receiptRequired, r.description, s.remedyLeft FROM remedies AS r LEFT JOIN storage AS s on r.id=s.remedyId WHERE name LIKE? LIMIT ?,?";
