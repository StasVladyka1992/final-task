...
//                //PooledConnection д.б. внутренним классом
//                PooledConnection pooledConnection = new PooledConnection(connection);
//                connectionQueue.add(pooledConnection);
//            }
//        } catch (ClassNotFoundException ex) {
//            throw new DAOException("Can't find driver", ex);
//        } catch (SQLException ex) {
//            throw new DAOException("SQLException in connection pool", ex);
//        }
//    }
//
//    public void dispose() {
...
//            throw new DAOException("Error connecting to the data source", ex);
//        }
//        return connection;
//    }
//
